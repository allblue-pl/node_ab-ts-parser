...
export class abTSValidator_Class {
    ...
    validateData(projectFSPath        , scriptFSPath        , scriptPath        , 
            data        )                {
    ...
    async validateTSConfig_Async(projectFSPath        , tsconfigFSPath        )                         {
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                resolve([ `Cannot parse '${tsconfigFileFSPath}': ` + (err         ) ]);
                return;
            }
    ...
    #validateData_ValidateFunctions(projectFSPath        , scriptFSPath        , 
    ...
    #validateTSConfig_Settings(tsconfigFSPath        , 
            tsconfig                              , errors               )       {
