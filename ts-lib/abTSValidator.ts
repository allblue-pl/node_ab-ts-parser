...
export class abTSValidator_Class {
    ...
    validateData(scriptFSPath: string, scriptPath: string, data: string, 
            errors: Array<string>) {
    ...
    #validateData_ValidateFunctions(scriptFSPath: string, scriptPath: string, 
            sourceFile: SourceFile, errors: Array<string>) {
        /* Raw Functions */
    ...
    #validateData_ValidateModule(scriptFSPath: string, scriptPath: string,
            data: string, errors: Array<string>) {
