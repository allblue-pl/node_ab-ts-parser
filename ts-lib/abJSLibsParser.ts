...
export class abTSParser_Class {
    ...
    parseData(scriptFSPath: string, scriptPath: string, data: string, 
    ...
    #parseData_AddJSLibsExports(scriptFSPath: string, scriptPath: string, 
    ...
    #parseData_ReplaceImports(sourceFile: SourceFile, data: string): string {
    ...
    #parseData_ReplaceImports_FindReferences(importDeclaration: ImportDeclaration,
            sourceFile: SourceFile, importName: string, aliasName: string|undefined, 
            importReferenceFinds: ReferencedSymbol[], 
            replaces: Array<{start: number, length: number, text: string}>): void {
